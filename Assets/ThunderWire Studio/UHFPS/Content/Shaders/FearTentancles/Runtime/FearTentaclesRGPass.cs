...
{
    public class FearTentaclesRGPass : ScriptableRenderPass
    {
        ...
        private const string PROFILER_TAG = "FearTentacles";
        private readonly Material material;
        private float effectTime;

        public FearTentaclesRGPass(RenderPassEvent renderPassEvent, Material material)
        {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            FearTentacles fearTent = stack.GetComponent<FearTentacles>();
