    ...
    public class GameLocaizationTableEditor : InspectorEditor<GameLocaizationTable>
    {
        ...
        public override void OnInspectorGUI()
        {
            EditorDrawing.DrawInspectorHeader(
                new GUIContent("Game Localization Table"),
                Target
            );
                ...
                roundedBox: false))
            {
                ...
                else
                {
                    EditorGUILayout.HelpBox(
                        "There are currently no languages available, open the localization editor and add new languages.",
                        MessageType.Info
                    );
                }
            }
        ...
        {
            EditorWindow window =
                EditorWindow.GetWindow<LocalizationTableWindow>(
                    true,
                    "Localization Editor",
                    true
                );
            ...
            ((LocalizationTableWindow)window).Show(asset);
        }
    }
}