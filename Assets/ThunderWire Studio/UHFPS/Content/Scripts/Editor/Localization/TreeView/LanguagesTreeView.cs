...
{
    public class LanguagesTreeView : TreeView<int>
    {
        ...
        internal class LanguageTreeViewItem : TreeViewItem<int>
        {
        ...
        public LanguagesTreeView(TreeViewState<int> state, LocalizationWindowData data) : base(state)
        {
            windowData = data;
            rowHeight = 20f;
            Reload();
        ...
        {
            var root = new TreeViewItem<int> { id = 0, depth = -1, displayName = "Languages" };
            int id = 1;
