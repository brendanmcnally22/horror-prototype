...
{
    public class TableSheetTreeView : TreeView<int>
    {
        ...
        internal class LstrSectionTreeViewItem : TreeViewItem<int>
        {
        ...
        internal class LstrEntryTreeViewItem : TreeViewItem<int>
        {
        ...
        public TableSheetTreeView(TreeViewState<int> state, LocalizationWindowData data) : base(state)
        {
            windowData = data;
            rowHeight = 20f;
            Reload();
        ...
        protected override TreeViewItem<int> BuildRoot()
        {
            ...
            var root = new TreeViewItem<int> { id = id++, depth = -1, displayName = "TableSheet" };
