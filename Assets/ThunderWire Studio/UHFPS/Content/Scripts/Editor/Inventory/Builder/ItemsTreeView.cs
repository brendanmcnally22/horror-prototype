...
{
    public class ItemsTreeView : TreeView<int>
    {
        ...
        internal class InventoryTreeViewItem : TreeViewItem<int>
        {
        ...
        public ItemsTreeView(TreeViewState<int> viewState, BuilderData builderData) : base(viewState)
        {
        ...
        {
            var root = new TreeViewItem<int> { id = 0, depth = -1, displayName = "Inventory" };
            int id = 1;
