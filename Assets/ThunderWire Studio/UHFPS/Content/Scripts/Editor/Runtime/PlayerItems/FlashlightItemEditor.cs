    ...
    public class FlashlightItemEditor : PlayerItemEditor<FlashlightItem>
    {
        public override void OnInspectorGUI()
        {
            ...
            serializedObject.Update();
            {
                ...
                EditorGUILayout.Space();
                if (EditorDrawing.BeginFoldoutToggleBorderLayout(new GUIContent("UV Flashlight Reveal"), Properties["EnableUVFlashlight"]))
                {
                    Properties.Draw("UVSwitchMethod");
                    Properties.Draw("UVBatteryDrainMultiplier");
                    Properties.Draw("SwitchToUVFlashlight");
                    Properties.Draw("UVFlashlightColor");
                    Properties.Draw("NormalFlashlightColor");
                    Properties.Draw("UVFlashlightSwitchSound");
