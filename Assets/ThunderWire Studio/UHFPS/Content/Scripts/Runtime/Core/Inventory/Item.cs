...
namespace UHFPS.Runtime
{
    ...
    public enum UsableType { PlayerItem, HealthItem, CustomEvent, Custom }
    ...
    public sealed class Item
    {
        ...
        public struct ItemSettings 
        {
            ...
            public bool applyAttributesOnUse;
        }
        ...
        public struct ItemCombineSettings
        {
            ...
            public bool IsNormal => itemType == ItemType.NormalItem;
            public bool IsCrafting => itemType == ItemType.CraftableItem;
            ...
            [Tooltip("The type of the item that will determine if the item is a normal inventory item or a craftable item.")]
