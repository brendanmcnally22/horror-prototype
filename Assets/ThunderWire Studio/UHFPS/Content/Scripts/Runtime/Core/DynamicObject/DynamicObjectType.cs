...
namespace UHFPS.Runtime
{
    ...
    public abstract class DynamicObjectType
    {
        ...
        /// <summary>
        /// Override this method to define custom actions when player tries to open a locked dynamic object.
        /// </summary>
        ...
        /// <summary>
        /// Override this method to clear the parameters after you stop interacting with the dynamic object.
        /// </summary>
        ...
        {
            return DynamicObject.TryUnlock();
        }
