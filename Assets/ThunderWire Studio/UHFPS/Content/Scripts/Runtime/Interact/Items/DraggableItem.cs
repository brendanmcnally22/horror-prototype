...
namespace UHFPS.Runtime
{
    ...
    public class DraggableItem : SaveableBehaviour, IDraggableObject, IOnDragStart, IOnDragEnd
    {
        public bool AllowDragging => true; // Default behavior of DraggableItem is always true.
        
        public MinMax ZoomDistanceValue
        {
            get => ZoomDistance;
            set => ZoomDistance = value;
        }

        public float MaxHoldDistanceValue
        {
            get => MaxHoldDistance;
            set => MaxHoldDistance = value;
        }
