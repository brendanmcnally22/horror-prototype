...
namespace UHFPS.Runtime
{
    public class CutsceneTrigger : MonoBehaviour, IInteractStart, ISaveable
    {
        ...
        [Tooltip("When the cutscene ends, shift the player a slightly forward to create a smoother transition back to gameplay.")]
        public bool ShiftPlayerWhenCutsceneEnds = false;
        [Tooltip("When the cutscene ends, get the player feet position from the end position of the cutscene player.")]
        public bool GetPlayerFeetPositionFromEndPosition = false;
