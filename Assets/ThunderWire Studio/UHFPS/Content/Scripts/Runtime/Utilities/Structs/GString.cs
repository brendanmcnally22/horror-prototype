...
namespace UHFPS.Runtime
{
    ...
    public sealed class GString
    {
        ...
        /// <summary>
        /// Retrieves the localized string from GameLocalization system.
        /// If localization key starts with the '*', it will be treated as a normal string and the '*' will be removed.
        /// </summary>
        /// <returns></returns>
        public string GetLocalizedString()
        {
            ...
            else if (!string.IsNullOrEmpty(GlocText) && GameLocalization.HasReference)
            {
                Value = GameLocalization.Instance.GetLocalizedString(GlocText);
            }
        ...
        {
            if (string.IsNullOrEmpty(Value) || isSubscribed)
                return;
