...
namespace UHFPS.Runtime
{
    public class LookController : PlayerComponent
    {
        ...
        /// <summary> How much the look has changed this frame. </summary>
        public Vector2 DeltaInput { get; set; }

        /// <summary> Rotation around the X axis (horizontal). </summary>
        public Quaternion RotationX { get; private set; }

        /// <summary> Rotation around the Y axis (vertical). </summary>
        public Quaternion RotationY { get; private set; }

        /// <summary> Final combined rotation X + Y. </summary>
        public Quaternion RotationFinal { get; private set; }

        /// <summary> Forward look direction in 3D space. </summary>
        public Vector3 LookForward => RotationX * Vector3.forward;

        /// <summary> Right look direction on the XZ plane. </summary>
        public Vector3 LookCross => Vector3.Cross(LookForward2D, Vector3.up);

        /// <summary> Forward look direction on the XZ plane. </summary>
        ...
        /// <summary> Check if the look is currently locked. </summary>
        ...
        /// <summary>
        /// Lerp the look rotation manually. 
        /// This function should only be used in the Update() function.
        /// </summary>
        ...
        /// <summary>
        /// Set the current look rotation as starting look for custom lerp.
        /// </summary>
        public void SetStartingLook()
        {
            if (!customLerp)
            {
                startingLook = LookRotation;
        ...
        /// Set the current look rotation as starting look for custom lerp.
        /// </summary>
        public void SetStartingLook(Vector2 look)
        {
            if (!customLerp)
            {
                startingLook = look;
        ...
        /// <summary>
        /// Gradually interpolates the current look rotation towards the starting look rotation.
        /// </summary>
        public void LerpTowardsStartingLook(float smoothTime)
        {
            if (customLerp)
            {
                LookRotation.x = Mathf.SmoothDampAngle(LookRotation.x, startingLook.x, ref xVelocity, smoothTime);
                LookRotation.y = Mathf.SmoothDampAngle(LookRotation.y, startingLook.y, ref yVelocity, smoothTime);
            }
        }
