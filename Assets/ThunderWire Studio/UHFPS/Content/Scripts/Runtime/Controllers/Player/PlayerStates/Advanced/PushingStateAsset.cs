    ...
    public class PushingStateAsset : PlayerStateAsset
    {
        ...
        public class PushingPlayerState : FSMPlayerState
        {
            ...
            private bool CanMove(Vector3 direction)
            {
                ...
                return !Physics.CheckBox(newPosition, collider.size / 2, movable.rotation, collisionMask, QueryTriggerInteraction.Ignore);
            }
            ...
            private bool CanRotate(Quaternion rotation)
            {
                ...
                return !Physics.CheckBox(position, collider.size / 2, newRotation, collisionMask, QueryTriggerInteraction.Ignore);
            }
